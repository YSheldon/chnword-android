...
public class MediaPlayer {
   ...
   * is similar to {@link #setDisplay(android.view.SurfaceHolder)}.
   *
   ...
   *                               form {@link #setDataSource(java.io.FileDescriptor)}.
   */
   ...
   * with {@link #setDisplay(android.view.SurfaceHolder)} and thus can use the high-level
   ...
   *         registered via
   *         {@link #setOnVideoSizeChangedListener(io.vov.vitamio.MediaPlayer.OnVideoSizeChangedListener)}
   ...
   *
   * @return array of {@link io.vov.vitamio.MediaPlayer.TrackInfo}
   */
   ...
   * @param trackInfo
   * @return {@link io.vov.vitamio.MediaPlayer.TrackInfo#getTrackInfoArray()}
   */
